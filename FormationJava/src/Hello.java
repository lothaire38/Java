...
public class Hello
{
	...
	public static void main(String[] args)
	{
		...
		// BookType typeOfBook = BookType.SF
		;
		...
		//
		//
		// publish1.setNom("Glenat");
		// publish1.setSiret("12345678901234");
		//
		// author1.setName("Rowling");
		// author1.setFirstName("Johannes");
		//
		// livre1.setTitle("harry Potter apprend le C#");
		// livre1.setLang("FR-fr");
		// livre1.setNbPage(850);
		// livre1.setHouse(publish1);
		// livre1.addAuthor(author1);
		//
		...
		//
		// publish2.setNom("Casterman");
		// publish2.setSiret("23456789012345");
		//
		// author2.setName("Hawking");
		// author2.setFirstName("Stephen");
		//
		// author3.setName("Einstein");
		// author3.setFirstName("Albert");
		//
		// livre2.setTitle("La relativite restreinte appliqué au chat de
		// Schroëddiger");
		// livre2.setLang("FR-fr");
		// livre2.setNbPage(450);
		// livre2.setHouse(publish2);
		// livre2.addAuthor(author2);
		// livre2.addAuthor(author3);
		//
		// System.out.println(Counter.incremente());
		// System.out.println(Counter.incremente());
		// System.out.println(Counter.incremente());

		// ----------------------------------------------------------------------------------
		// System.out.println(livre1.toString());
		// System.out.println(publish1.toString());
		//
		// System.out.println(livre2.toString());
		// System.out.println(publish2.toString());
		...
		// ConfigInfo config2 = ConfigInfo.getInstance();
		// Ne peut pas être fait car le constructeur en fait une classe private
