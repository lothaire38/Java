...
public class Hello
{
	...
	public static void main(String[] args)
	{
		...
		/*
		 * if (book4 == book2) System.out.println("Livre identique"); else
		 * System.out.println("Livre different");
		 */

		CollectTest c = new CollectTest();

		// System.out.println("Les titres sont : ");
		//
		// for(Book b:c.listTest())
		//// for (Book b : c.setTest())
		//// for(Book b:c.mapTest())
		// {
		// System.out.println(" * " + b.getTitle());
		// }
		// Map<Integer, Book> m = c.mapTest();
		// Book b1 = new Book();
		// b1.setTitle("C#");
		// b1.setId(123);
		// b1 = m.get(123);
		...
		// myCart.getMedias().add(cd1);
		// myCart.getMedias().add(book1);
		// myCart.getMedias().add(dvd1);
		//
		// cd1.setPrice(10.00);
		// cd1.setTitle("U2\nSunday bloody sunday");
		// dvd1.setPrice(10.00);
		// dvd1.setTitle("Usual Suspect");
		// book1.setPrice(10.00);
		// book1.setTitle("Harry Potter à l'ecole des sorciers");
		//
		// for(Media m:myCart.getMedias())
		// {
		// System.out.println(m.getTitle());
		// System.out.println("Prix HT = "+m.getPrice());
		// System.out.println("Prix TTC = "+m.getVATPrice());
		// System.out.println();
		// }
		// TestFile tf = new TestFile();
		// try
		// {
		// tf.readFile("C:\\Users\\adminlocal\\Documents\\ExoIO\\Livre.csv");
		// } catch (IOException e)
		// {
		...
		br.setUri("C:\\Users\\adminlocal\\Documents\\ExoIO\\Livre.csv");
		...
		try
		{
			...
			// System.out.println("Auteur ="+b.getAuthors().display());
			// System.out.println("Editeur = "+b.getPublisher().toString());
			// }
			// bookById = br.getById(4);
			// System.out.println("Id = "+bookById.getId());
			// System.out.println("\tTitre = "+bookById.getTitle());

			 books = br.getByPrice(15.00);
//			books = br.getByTitle("monsieur");
			for (Book b : books)
			{
				System.out.println("Id = " + b.getId());
				System.out.println("\tTitre = " + b.getTitle());
